...
<img src="https://panyuro.oss-cn-beijing.aliyuncs.com/20230126125309.png" style="zoom:50%;" />

1. sudo -i 输入密码，进入root目录

2. 根据 services / bin / env-set.sh 中的以下内容：

   ```sh
   unset JRE_HOME JAVA_HOME CLASSPATH
   export nexus_redirect="http://http://192.168.0.100:8081/nexus/service/local/artifact/maven/redirect"
   export data_home="/var/root/svr"
   export server_home="$data_home/services"
   export JAVA_HOME="Users/panyurou/Library/Java/JavaVirtualMachines/corretto-1.8.0_342/Contents/Home"
   export CATALINA_HOME="/Users/panyurou/software/apache-tomcat-8.5.84"
   ...
   if [ -z "$g_env_set" ]; then
     unset JRE_HOME JAVA_HOME CLASSPATH
     export nexus_redirect="http://192.168.0.100:8081/nexus/service/local/artifact/maven/redirect"
     export data_home="/var/root/svr"
     export server_home="$data_home/services"
     export JAVA_HOME="Users/panyurou/Library/Java/JavaVirtualMachines/corretto-1.8.0_342/Contents/Home"
     export CATALINA_HOME="/Users/panyurou/software/apache-tomcat-8.5.84"
